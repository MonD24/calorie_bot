...
⚠️ КРИТИЧЕСКИ ВАЖНО: 
- Если на фото НЕСКОЛЬКО ТАРЕЛОК/БЛЮД - посчитай КАЖДОЕ ОТДЕЛЬНО и сложи в общий итог!
- Игнорируй посторонние предметы (таблетки, салфетки, телефон). Анализируй ТОЛЬКО ЕДУ!

📋 ШАГ 1 - ДЕТАЛЬНОЕ ОПИСАНИЕ:
Если на фото НЕСКОЛЬКО блюд/тарелок, опиши КАЖДОЕ:
"На фото два блюда:
1) [первое блюдо]: [ингредиенты]
2) [второе блюдо]: [ингредиенты]"

Если ОДНО блюдо: "На фото [название блюда]: [ингредиенты]"

📊 ШАГ 2 - РАСЧЕТ КАЖДОГО БЛЮДА ОТДЕЛЬНО:
{CALORIE_DATABASE}

🔴 ВАЖНЫЕ КАЛОРИЙНОСТИ НА 100г:
• Макароны вареные: 112 ккал, 3.5г белка, 0.4г жира, 23г углеводов
• Котлета жареная (мясная): 220-280 ккал, 15-18г белка, 15-20г жира
• Котлета куриная: 190 ккал, 18г белка, 10г жира
• Морковь по-корейски: 134 ккал, 1.2г белка, 8.9г жира, 12г углеводов
• Рыба жареная: 180-220 ккал, 20г белка, 10-15г жира
• Селедка/скумбрия: 200-250 ккал, 18г белка, 15-18г жира

⚠️ ТИПИЧНЫЕ ПОРЦИИ:
• Тарелка макарон: 150-200г вареных = 170-225 ккал
• 2 котлеты средних: ~150г = 330-400 ккал
• Порция моркови по-корейски: 100-150г = 134-200 ккал
• Порция рыбы: 100-150г = 200-300 ккал
• Стакан воды: 0 ккал

🧮 ШАГ 3 - РАСЧЕТ ДЛЯ КАЖДОГО БЛЮДА:
**БЛЮДО 1 (например, макароны с котлетами):**
Макароны ~180г: 112 × 1.8 = 202 ккал, Б:6.3г, Ж:0.7г, У:41г
Котлеты 2шт ~150г: 250 × 1.5 = 375 ккал, Б:25г, Ж:28г, У:5г
Подытог блюда 1: 577 ккал, 31.3г белка, 28.7г жиров, 46г углеводов

**БЛЮДО 2 (например, морковь по-корейски с рыбой):**
Морковь по-корейски ~120г: 134 × 1.2 = 161 ккал, Б:1.4г, Ж:10.7г, У:14.4г
Рыба ~100г: 200 × 1.0 = 200 ккал, Б:20г, Ж:12г, У:0г
Подытог блюда 2: 361 ккал, 21.4г белка, 22.7г жиров, 14.4г углеводов

💯 ШАГ 4 - ОБЩИЙ ИТОГ (СУММА ВСЕХ БЛЮД):
ИТОГО: 938 ккал, 52.7 г белка, 51.4 г жиров, 60.4 г углеводов

🚨 ПРАВИЛА:
• Котлеты ВСЕГДА высококалорийные (жареные в масле)!
• 2 котлеты = минимум 300-400 ккал
• Морковь по-корейски калорийная из-за МАСЛА!
• Если видишь 2 тарелки - итог должен быть 500+ ккал!
• НЕ объединяй разные тарелки в одно блюдо - считай отдельно!
